...
$archivePath = Join-Path $projectRoot 'OWM_COURSE_OFFLINE_3.60.0.zip'
...
$expectedArchivePath = [System.IO.Path]::GetFullPath((Join-Path $projectRoot 'OWM_COURSE_OFFLINE_3.60.0.zip'))
